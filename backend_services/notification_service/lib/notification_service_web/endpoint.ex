defmodule NotificationServiceWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_notification_service_key",
    signing_salt: "ZxsSQ9Br",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    gzip: false,
    only: NotificationServiceWeb.static_paths()

  # Code reloading can be explicitly enabled under the
  # :code_reloader configuration of your endpoint.
  if code_reloading? do
    plug Phoenix.CodeReloader
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :notification_service
  end
